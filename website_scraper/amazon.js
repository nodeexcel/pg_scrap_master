            ...
            if( response_type == 'error'){
                ...
                try{
                    ...
                    if( jQuery('a').length > 0 ){
                        ...
                        //-----start pick left side categories listing
                        if( jQuery('.categoryRefinementsSection').find('li').find('a').length > 0 ){
                            jQuery('.categoryRefinementsSection').find('li').find('a').each( function(){
                        ...
                        //-----end pick left side categories listing
                        
                        jQuery('header').remove();
                        jQuery('#navFooter').remove();
                        jQuery('#rhf').remove();
                        jQuery('#refinements').remove();
                        jQuery('.a-col-left').remove();
